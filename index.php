        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/icoderBootstrap/index.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/icoderBootstrap/about.php">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/icoder/Bootstrap/contact.php">Contact</a>
                </li>
